...
const getAllDeleted = (req, res) => {
  ...
  deletedReturnsModel.getAllDeleted((err, results) => {
    if (err) {
...
const retrieveDeleted = (req, res) => {
  ...
  deletedReturnsModel.retrieveDeleted(returnID, (err, results) => {
    if (err) {
...
const deleteDeleted = (req, res) => {
  ...
  db.query(query, [adminPW], (err, results) => {
    ...
    deletedReturnsModel.deletePermanently(orderID, (err, results) => {
      if (err) {
